...
DEFAULT_MODEL_PATH = "weights/det_instrument_20260807.pt"
DEFAULT_IMAGE_PATH = "test_images/1786427500396.jpg"
...
def main():
	...
	reader.last_reading_details = reading_details
	...
	if reading_details is None:
		print("No valid gauge reading found. Showing detection boxes only.")
	else:
		reading = float(reading_details["reading"])
